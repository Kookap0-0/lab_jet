...
if __name__ == "__main__":
        ...
        ax.plot(x_range, y_range, 'b--', linewidth=2, label=f'y = {slope:.4f}x + {intercept:.4f}, см')

        ax.scatter(x, y, color='red', s=100, zorder=5, label='Исходные точки')
        ...
        ax.set_title('Калибровочный график зависимости перемещения трубки Пито от шага двигателя', fontsize=14)
        ax.legend(loc='best')
